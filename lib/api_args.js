...
Args.assertQueue = function(queue, options) {
  ...
  setIfDefined(argt, 'x-single-active-consumer', options.singleConsumer);
  setIfDefined(argt, 'x-max-length-bytes', options.maxLengthBytes);
  setIfDefined(argt, 'x-queue-leader-locator', options.queueLeaderLocator);
  setIfDefined(argt, 'x-queue-version', options.queueVersion);
  setIfDefined(argt, 'x-queue-master-locator', options.queueMasterLocator);
  setIfDefined(argt, 'x-delivery-limit', options.deliveryLimit);
  setIfDefined(argt, 'x-quorum-initial-group-size', options.quorumInitGroupSize);
  setIfDefined(argt, 'x-dead-letter-strategy', options.deadLetterStrategy);
  setIfDefined(argt, 'x-max-age', options.maxAge);
  setIfDefined(argt, 'x-stream-max-segment-size', options.streamMaxSegmentSize); 
  setIfDefined(argt, 'x-initial-cluster-size', options.initialClusterSize);
